...
function LandingPage() {
  const testimonials = [
    {
      ...
      text: `"The progress tracking feature changed everything for me. Seeing the days add up kept me motivated during the hardest weeks of my early recovery."`,
    },
    {
      name: "Jessica L.",
      role: "Sober for 18 months",
      image: "https://i.pravatar.cc/50?img=5",
      text: `"Finding a rehab center that actually took my insurance and specialized in my specific needs felt impossible until I found Recovery Path."`,
    },
    {
      name: "Amanda S.",
      role: "Daily user",
      image: "https://i.pravatar.cc/50?img=32",
      text: `"The daily motivation quotes are more than just words—they're a lifeline. This platform has truly become part of my daily self-care ritual."`,
    },
  ];
  const tools = [
    {
  ...
  const steps = [
    {
      ...
      description:
        "Set up your private, HIPAA-compliant profile in under two minutes.",
      isActive: true,
    },
    {
      number: 2,
      title: "Connect",
      description:
        "Match with the right clinical team or finding a local treatment center.",
      isActive: false,
    },
    {
      number: 3,
      title: "Track",
      description:
        "Log your daily progress and attend your first session with confidence.",
      isActive: false,
    },
  ];
  ...
  return (
    <div>
      <div className="min-h-screen bg-[#f5f7fb] px-8 py-10 pt-28">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="mt-5 text-gray-500 max-w-lg">
              Find the specialized support, clinical expertise, and community
              strength you need to build a stable, healthy future. Professional
              guidance, at every step.
            </p>

            {/* Buttons */}
            <div className="flex flex-wrap gap-4 mt-8">
              <button className="px-8 py-4 bg-blue-600 cursor-pointer hover:bg-blue-700 text-white rounded-xl font-medium transition">
                Get Started
              </button>

              <button className="px-8 py-4 border border-gray-300 cursor-pointer hover:bg-gray-100 rounded-xl font-medium text-gray-700 transition">
                Find Support
              </button>
            </div>
            ...
            <div className="flex items-center gap-3 mt-8">
              ...
              <p className="text-sm text-gray-500">
                Joined by <span className="font-semibold">2,400+</span> people
                this month
              </p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-6 left-6 bg-white rounded-xl shadow-lg px-5 py-4 flex items-center gap-3">
              ...
              <div>
                ...
                <h4 className="font-semibold text-gray-800">365 Days Sober</h4>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto mt-14 grid md:grid-cols-4 gap-5">
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-200">
            ...
            <h2 className="text-5xl font-bold text-blue-600 mt-4">94%</h2>
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-200">
            ...
            <h2 className="text-5xl font-bold text-green-600 mt-4">12.5k</h2>
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-200">
            ...
            <h2 className="text-5xl font-bold text-gray-800 mt-4">450+</h2>

            <p className="text-sm text-gray-500 mt-2">Across 50 states</p>
          </div>

          {/* Card 4 */}
          <div className="bg-blue-700 text-white rounded-xl p-6">
            <p className="text-sm opacity-80">Your Next Session</p>

            <h3 className="text-2xl font-bold mt-4">Tomorrow, 10:00 AM</h3>

            <p className="text-sm mt-2 opacity-80">With Dr. Sarah Mitchell</p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1 w-full relative">
            ...
            <p className="text-slate-500 text-lg mb-10 max-w-md">
              We've streamlined the intake process to focus on what matters:
              your recovery.
            </p>
          ...
          <div className="flex-1 w-full relative">
            ...
            <div className="absolute -top-5 right-0 lg:-right-8 bg-white px-5 py-3 rounded-xl shadow-lg flex items-center gap-3 z-10">
              <svg
                xmlns="https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=1200"
                viewBox="0 0 24 24"
                fill="currentColor"
      ...
      <section className="w-full bg-[#EEF2FA]">
        {/* Testimonials Section */}
        <div className="max-w-7xl mx-auto px-5 py-12">
          <h2 className="text-center text-[42px] font-bold text-[#1E293B] mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {testimonials.map((item, index) => (
              <div
                key={index}
                className="bg-white rounded-xl p-6 shadow-sm border border-[#E5EAF2]"
              >
                ...
                <p className="text-[15px] italic text-[#374151] leading-7 min-h-[120px]">
                  {item.text}
                </p>
        ...
        <div className="bg-white py-10 px-5">
          <div className="max-w-7xl mx-auto">
            <div className="relative overflow-hidden rounded-[22px] bg-[#3366E8] min-h-[280px] flex flex-col items-center justify-center text-center px-8">
              {/* Top Right Circle */}
              ...
              <p className="text-white/70 max-w-xl text-lg leading-8 mb-10">
                Take the first step toward the life you deserve. We're here to
                walk alongside you every step of the way.
              </p>

              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-white text-[#3366E8] px-10 py-4 rounded-md font-medium min-w-[190px] hover:bg-gray-100 transition">
                  Join Recovery Path
                </button>

                <button className="border border-white/50 text-white px-10 py-4 rounded-md font-medium min-w-[190px] hover:bg-white/10 transition">
                  Talk to an Expert
                </button>
              </div>
            </div>
